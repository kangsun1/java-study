...
public class Quiz01 {
	...
	public static void main(String[] args) {
		 ...
		 * 관련 정보 저장을 위해 아래 데이터 저장을 위한 변수를 선언하고 값을
		 * 저장해보세요!
		 * 
		 * 회사명 : SAMSUNG 
		 * 모니터인치 : 24 
		...
		int inch = 24;
		String color = "black";
		boolean hdmiPort = true; //String -> boolean
		...
		/*
		 * 4. 두 개의 문자열 변수가 우리에게 주어졌습니다. 
		 * 그런데 해당 문자열 변수는 어떤 학생의 점수를 가지고 있습니다. 
		 * 주어진 점수들의 전체
		 * 합을 계산하고 싶습니다. 
		 * 모든 점수를 더해서 총점이 얼마인지 출력하세요. 
		 * (*힌트 : 숫자처럼 덧셈을 하기위해서는 숫자형태로의 변환이
		 * 필요합니다.)
		 * 
		 * 주어진 변수 
		 * String mathScore = "85"; 
		 ...
		 * 4 / 10 을 실행시켜서 
		 * 결과가 0.4 가 나오는 것을 보여주려고 하는데 아래
		 * 계산 결과가 맞지 않습니다. 
		 * 정상적으로 0.4 가 계산되서 출력되도록 만들어주세요.
		 * 
		 * int num1 = 4; int num2 = 10; double num3 = num1 / num2 ; System.out.println(
		 * num3 );
		 * 
		 */
		...
		double num3 = (double)num1 / num2 ; 	//int / int -> int  4/10 = double num3 = 0.0;
